...
import {firstReview, secondReview} from '../data/data';

export default function Body({userReview}) {
    return (
   <main>
      <Experience>
        <ExperienceContent>
          ...
          <picture>
            <source
              ...
              srcSet='./assets/experience-des.png'
            />
            <img src='./assets/experience-mob.png' alt='Black girls' />
          </picture>
        </ExperienceContent>
      </Experience>
      ...
      <Experience2>
        <ExperienceContent2>
          <picture>
            <source
              media='(min-width: 477.49px)'
              srcSet='./assets/josiah-experience-des.png'
            />
            <img
              src='./assets/josiah-experience-mob.png'
              alt='Woman smiling'
            />
          </picture>
          <div>
